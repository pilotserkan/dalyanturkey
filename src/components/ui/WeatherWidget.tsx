...
/* ------------------------------------------------------------------ */
const MONTHS = [
  { key: 'jan', airHigh: 15, airLow: 6,  seaTemp: 17, rain: 170, sun: 5,  wind: 12, uv: 2, humidity: 70, swim: false },
  { key: 'feb', airHigh: 16, airLow: 6,  seaTemp: 16, rain: 130, sun: 6,  wind: 11, uv: 3, humidity: 65, swim: false },
  { key: 'mar', airHigh: 19, airLow: 8,  seaTemp: 17, rain: 80,  sun: 7,  wind: 10, uv: 5, humidity: 60, swim: false },
  { key: 'apr', airHigh: 23, airLow: 11, seaTemp: 18, rain: 40,  sun: 9,  wind: 9,  uv: 7, humidity: 55, swim: false },
  { key: 'may', airHigh: 28, airLow: 15, seaTemp: 20, rain: 25,  sun: 11, wind: 8,  uv: 9, humidity: 50, swim: true },
  { key: 'jun', airHigh: 33, airLow: 19, seaTemp: 24, rain: 8,   sun: 13, wind: 8,  uv: 10, humidity: 40, swim: true },
  { key: 'jul', airHigh: 36, airLow: 22, seaTemp: 26, rain: 3,   sun: 14, wind: 9,  uv: 11, humidity: 35, swim: true },
  { key: 'aug', airHigh: 36, airLow: 22, seaTemp: 27, rain: 2,   sun: 13, wind: 8,  uv: 10, humidity: 38, swim: true },
  { key: 'sep', airHigh: 32, airLow: 18, seaTemp: 26, rain: 15,  sun: 11, wind: 7,  uv: 8, humidity: 45, swim: true },
  { key: 'oct', airHigh: 27, airLow: 14, seaTemp: 23, rain: 60,  sun: 8,  wind: 8,  uv: 5, humidity: 55, swim: true },
  { key: 'nov', airHigh: 21, airLow: 10, seaTemp: 20, rain: 120, sun: 6,  wind: 10, uv: 3, humidity: 65, swim: false },
  { key: 'dec', airHigh: 16, airLow: 7,  seaTemp: 18, rain: 190, sun: 5,  wind: 12, uv: 2, humidity: 70, swim: false },
];
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-gradient-to-r from-sky-700 to-sky-800 text-white">
                ...
                <th className="px-3 py-3 text-center font-semibold text-xs">🏊 {t('swimShort')}</th>
              </tr>
            </thead>
            <tbody>
              {MONTHS.map((m, i) => (
